...
// const unisWithUni = [];
// for(i = 0; i < graduates.length; i++){
//   if(graduates[i].university.includes('Uni') == graduates[i].university.indexOf('Uni')){
//     unisWithUni.push(graduates[i].university);
//   }
//}

// console.log(unisWithUni);
const ordered = universities.filter(item =>
  item.includes('Uni')
);
console.log(ordered);
...
const lowCaseAnimalNames = zooAnimals.map((zooAnimal, zooAnimals) => {
...
zooAnimals.filter((zooAnimal, zooAnimals) => {
